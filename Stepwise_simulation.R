#Achtung: gibt nicht mehr alle mrnas aus!!!!!!!!!!!!!!!!!!!!!!!!!!!!
#ändern falls gewünscht
#Ändern in eval und Multiple core Function

stepwise_simulation2 <- function(name_of_outputfile = "random",
                                ...
                                sRNA_laenge = 25){
  ##### Beschreibung #####
  # name_of_outputfile: Name dies Outputfiles (ohne .RData)
  ...
  # time_steps: Anzahl der Mutationszyklen die gemacht werden ( 10 "time_steps" und 100k "durchlaeufe" ergeben im gesamten 1M Mutationen)
  # wiederholungen: Angabe wie oft die Prozedur wiederholt werden soll
  #                 Die Wiederholungen Multipliziert mit den Cores gibt die gesamtanzahl an versuchsdurchläufen wieder die gemacht wurden
  ...
  # keep_all_rnas: TRUE/FALSE ob alle rnas ausgegeben werden sollen. Bei FALSE werden alle mRNAs gelöscht und nicht mit ausgegeben. 
  #               ACHTUNG: Bei TRUE verbraucht die berechnung sehr viel Arbeitsspeicher und die End Datei kann sehr Groß werden.
  # mrna_lange: laenge der mRNA, falls diese Randomisiert sein sollen
  # mRNA_anzahl_ Anzahl der mRNA's falls diese Randomisiert sein sollen
  # srna_laenge: länge der sRNA, falls diese Randomisiert sein sollen
  ##### Beschreibung Ende #####
