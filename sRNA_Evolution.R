...
setwd("/home/ekempmann/sRNA Rfunktionen/Working directory1")
require(seqinr)
srna <- read.fasta("Ryhblong.fa")
mrna <- read.fasta("mRNA.fa")
go3 <- list(":0005506~iron ion binding,") 
accessibility <- TRUE
test <- srna_evolution2(srna,
                       mrna,
                       translation_start = 34,
                       durchlaeufe = 30000,
                       target_grenze = -14,
                       store = 200,
                       targets_schwelle = 0.8,
                       term_schwelle = 0.9,
                       go_terms = go3,
                       keep_mrna = "no",
                       target_constrain = FALSE,
                       go_term_constrain = FALSE,
                       rna_constrain = TRUE)
